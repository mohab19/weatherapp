function op() {
    ...
    ?
    ( ee = 0, selected =
        document.getElementById("hour").selectedIndex, document.getElementById("all").style.display = "none", document.getElementById("s").style.display = "block", document.getElementById("a").disabled =! 1,
...
function chang(b) {
    ...
    document.getElementById("hour").selectedIndex+1 < document.getElementById("hour").length && (
        document.getElementById("hour").selectedIndex = document.getElementById("hour").selectedIndex+1, update()
    )
    :
    ...
    else
    {
        if( document.getElementById("hour").length > document.getElementById("hour").selectedIndex + 1 )
        {
            if( 0 < ee ) {
                ...
                B = document.getElementById("hour").value; document.getElementById("img").src = B;
                var b = new Image, c = B;
                b.onload = function() {
...
function setVisibility(b) {
    ...
    ?
    (document.getElementById("bt1").value = "Show Layer", document.getElementById("bt1").innerHTML = "\u0625\u0638\u0647\u0627\u0631 \u0623\u0633\u0645\u0627\u0621 \u0627\u0644\u0645\u062f\u0646", c = "hidden")
    :
    (document.getElementById("bt1").value = "\u0625\u062e\u0641\u0627\u0621 \u0627\u0644\u062e\u0631\u064a\u0637\u0629",
    document.getElementById("bt1").innerHTML = "\u0625\u062e\u0641\u0627\u0621 \u0623\u0633\u0645\u0627\u0621 \u0627\u0644\u0645\u062f\u0646", c = "visible");
